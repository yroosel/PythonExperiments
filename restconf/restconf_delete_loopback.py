...
r = requests.delete(f"{base}/ietf-interfaces:interfaces/interface={name}", auth=auth, headers=HEADERS, verify=False)
print("DELETE:", r.status_code, r.text if r.status_code >= 300 else "")
